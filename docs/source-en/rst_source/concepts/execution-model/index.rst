...
.. list-table::
   ...
   * - :doc:`TrajectoryChannel <../trajectory_channel>`
     - Trajectory requests, record aggregation, and delivery for asynchronous embodied training.
...
.. toctree::
   ...
   Cluster <../cluster>
   Channel <../channel>
   TrajectoryChannel <../trajectory_channel>
