...
from rlinf.workers.actor.async_ppo_fsdp_worker import AsyncPPOEmbodiedFSDPActorWorker
...
def main(cfg) -> None:
    ...
    actor_group = AsyncPPOEmbodiedFSDPActorWorker.create_group(cfg).launch(
        cluster,
