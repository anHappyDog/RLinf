...
class AsyncPPOEmbodiedFSDPActorWorker(EmbodiedFSDPActor):
    ...
    def run_training(self) -> dict[str, Any]:
        ...
        for _ in range(update_epoch):
            global_batch_iter = get_iterator_k_split(
                self.rollout_batch,
                num_splits=num_global_batches,
                shuffle=False,
            ...
            for train_global_batch in global_batch_iter:
                ...
                micro_batch_iter = get_iterator_k_split(
                    train_global_batch,
