...
run_phase g2_100_re_baseline "${MAIN_REPO}" "${BASELINE_CONFIG}" || true
run_phase g2_100_re_trajectory "${TRAJECTORY_REPO}" "${TRAJECTORY_CONFIG}" \
...
echo "$(date -Is) pair34 matrix finished"
